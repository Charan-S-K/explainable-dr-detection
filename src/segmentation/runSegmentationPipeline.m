...
if isempty(vesselNetWeighted)
    ...
    S = load(fullfile(projectRoot, ...
        'models','haemorrhageNet.mat'), ...
        'haemorrhageNet');

    haemorrhageNet = S.haemorrhageNet;
    ...
    S = load(fullfile(projectRoot, ...
        'models','softExudatePatchNet.mat'), ...
        'softExudatePatchNet');

    softExudatePatchNet = ...
        S.softExudatePatchNet;
...
%
% Accepted prototype baseline = haemorrhageNet
%% =========================================================

fprintf('\n[3/5] Segmenting haemorrhages...\n');

haemorrhageProb = predictPaddedProbMap( ...
    I, ...
    haemorrhageNet, ...
    512);

haemorrhageMask = haemorrhageProb >= 0.50;

function probMap = predictMicroaneurysmProbMap(I,net)
% Full-resolution Microaneurysm probability map
...
for r = rowStarts
    ...
    for c = colStarts
        ...
        scoreMap(rows,cols) = ...
            scoreMap(rows,cols) + single(maScore);
...
%% Keep prediction only inside retina
